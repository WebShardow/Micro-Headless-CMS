# 🚀 Micro Headless CMS (Ultra Premium v1.5)

ระบบจัดการเนื้อหา (CMS) ระดับ High-end ที่มีความเร็วสูง สวยหรู และยืดหยุ่น ออกแบบมาเพื่อธุรกิจสตาร์ตอัปและพอร์ตโฟลิโอรุ่นใหม่ สร้างด้วย Next.js 15, Tailwind CSS 4 และ Prisma ครับ

## ✨ ฟีเจอร์เด่น (Features)
*   **💎 Grand Landing Page:** หน้าแรกสไตล์ Glassmorphism ที่ออกแบบโชว์ความโปร่งแสงและ Gradient แบบพรีเมียม
*   **🔤 Custom Typography (Thai Ready):** เลือกใช้ฟอนต์ยอดนิยมอย่าง Kanit, Prompt, Sarabun, Chakra Petch ได้ทันทีจากหน้า Admin
*   **🎨 Professional UI Design:** ตัดความโค้งมนที่มากเกินไปให้เหลือระดับที่ดูคม (Sharp & Modern) เข้าได้กับทุกแบรนด์
...
2. เตรียมฐานข้อมูล: `npx prisma db push`
3. รันโปรเจกต์: `npm run dev`
